...
| display_rules()      | Display the rules of the Hangman game. The function will print the main objective, gameplay and the number of tries the user has to correctly guess the word.                                                                                                                                                                                                                          |
| Username()           | The function will print the main objective, gameplay and the number of tries the user has to correctly guess the word.                                                                                                                                                                                                                                                                 |
